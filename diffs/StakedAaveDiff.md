...
@@ -1721,23 +887,325 @@ interface ITransferHook {
...
@@ -4058,13 +4059,68 @@ contract StakedTokenV3 is
...
@@ -4094,19 +4150,6 @@ interface IStakedAaveV3 is IStakedTokenV3 {
...
@@ -4176,15 +4219,16 @@ interface IERC20WithPermit is IERC20 {
...
+    return 6;
   ...
   constructor(
@@ -4277,18 +4321,6 @@ contract StakedAaveV3 is StakedTokenV3, IStakedAaveV3 {
...
@@ -4315,101 +4347,5 @@ contract StakedAaveV3 is StakedTokenV3, IStakedAaveV3 {
         )
       {} catch (bytes memory) {}
     }
