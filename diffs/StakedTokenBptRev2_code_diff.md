...
@@ -111,7 +193,280 @@ interface IERC20 {
...
@@ -137,39 +493,35 @@ interface IERC20 {
...
@@ -177,38 +529,44 @@ contract ERC20 is Context, IERC20 {
...
@@ -217,11 +575,17 @@ contract ERC20 is Context, IERC20 {
    *
    * Requirements:
    *
...
@@ -241,12 +605,21 @@ contract ERC20 is Context, IERC20 {
   /**
...
@@ -254,25 +627,26 @@ contract ERC20 is Context, IERC20 {
...
@@ -288,8 +662,13 @@ contract ERC20 is Context, IERC20 {
    *
    * - `spender` cannot be the zero address.
    */
...
@@ -312,44 +691,53 @@ contract ERC20 is Context, IERC20 {
     virtual
     returns (bool)
   {
-    _approve(
...
@@ -357,18 +745,20 @@ contract ERC20 is Context, IERC20 {
    *
...
+    _afterTokenTransfer(address(0), account, amount);
   ...
   /**
@@ -377,7 +767,7 @@ contract ERC20 is Context, IERC20 {
    *
...
@@ -387,15 +777,22 @@ contract ERC20 is Context, IERC20 {
...
@@ -418,14 +815,25 @@ contract ERC20 is Context, IERC20 {
   }
...
+    }
   ...
   /**
@@ -435,7 +843,7 @@ contract ERC20 is Context, IERC20 {
    * Calling conditions:
    *
...
@@ -447,9 +855,27 @@ contract ERC20 is Context, IERC20 {
     address to,
     uint256 amount
   ) internal virtual {}
-}
...
@@ -461,8 +887,6 @@ interface IStakedAave {
...
-
 interface ITransferHook {
   function onTransfer(
     address from,
@@ -471,8 +895,6 @@ interface ITransferHook {
   ) external;
 }
...
@@ -487,238 +909,11 @@ library DistributionTypes {
   }
 }
...
@@ -734,7 +928,10 @@ library SafeERC20 {
     address to,
     uint256 value
   ) internal {
...
@@ -743,38 +940,93 @@ library SafeERC20 {
     address to,
     uint256 value
   ) internal {
...
-
  ...
  *
@@ -800,7 +1052,10 @@ abstract contract VersionedInitializable {
    */
...
@@ -815,23 +1070,18 @@ abstract contract VersionedInitializable {
...
@@ -849,10 +1099,14 @@ contract AaveDistributionManager is IAaveDistributionManager {
...
@@ -860,14 +1114,15 @@ contract AaveDistributionManager is IAaveDistributionManager {
...
+      ];
       ...
       _updateAssetStateInternal(
         assetsConfigInput[i].underlyingAsset,
@@ -903,8 +1158,12 @@ contract AaveDistributionManager is IAaveDistributionManager {
       return oldIndex;
     }
...
@@ -954,21 +1213,21 @@ contract AaveDistributionManager is IAaveDistributionManager {
...
@@ -980,26 +1239,28 @@ contract AaveDistributionManager is IAaveDistributionManager {
    * @param stakes List of structs of the user data related with his stake
    * @return The accrued rewards for the user until the moment
    **/
...
@@ -1016,7 +1277,9 @@ contract AaveDistributionManager is IAaveDistributionManager {
...
+      (10**uint256(PRECISION));
   ...
   /**
@@ -1042,13 +1305,13 @@ contract AaveDistributionManager is IAaveDistributionManager {
       return currentIndex;
     }
...
+        totalBalance) + currentIndex;
   ...
   /**
@@ -1057,110 +1320,28 @@ contract AaveDistributionManager is IAaveDistributionManager {
...
@@ -1176,7 +1357,10 @@ abstract contract GovernancePowerDelegationERC20 is ERC20, IGovernancePowerDeleg
    * @param delegatee the user which delegated power has changed
    * @param delegationType the type of delegation (VOTING_POWER, PROPOSITION_POWER)
    **/
...
@@ -1199,7 +1383,11 @@ abstract contract GovernancePowerDelegationERC20 is ERC20, IGovernancePowerDeleg
     override
     returns (address)
   {
...
@@ -1248,7 +1436,12 @@ abstract contract GovernancePowerDelegationERC20 is ERC20, IGovernancePowerDeleg
...
@@ -1264,7 +1457,11 @@ abstract contract GovernancePowerDelegationERC20 is ERC20, IGovernancePowerDeleg
   ) internal {
...
@@ -1272,7 +1469,12 @@ abstract contract GovernancePowerDelegationERC20 is ERC20, IGovernancePowerDeleg
...
@@ -1314,10 +1516,10 @@ abstract contract GovernancePowerDelegationERC20 is ERC20, IGovernancePowerDeleg
         snapshotsCounts,
         from,
         uint128(previous),
...
+      emit DelegatedPowerChanged(from, previous - amount, delegationType);
     ...
     if (to != address(0)) {
       uint256 previous = 0;
@@ -1333,10 +1535,10 @@ abstract contract GovernancePowerDelegationERC20 is ERC20, IGovernancePowerDeleg
         snapshotsCounts,
         to,
         uint128(previous),
...
@@ -1440,11 +1642,10 @@ abstract contract GovernancePowerDelegationERC20 is ERC20, IGovernancePowerDeleg
...
@@ -1455,16 +1656,14 @@ abstract contract GovernancePowerDelegationERC20 is ERC20, IGovernancePowerDeleg
   }
 }
...
@@ -1484,24 +1683,188 @@ abstract contract GovernancePowerWithSnapshot is GovernancePowerDelegationERC20
   }
 }
...
@@ -1521,25 +1884,38 @@ contract StakedTokenBptRev2 is
...
@@ -1553,26 +1929,24 @@ contract StakedTokenBptRev2 is
...
@@ -1583,31 +1957,37 @@ contract StakedTokenBptRev2 is
...
@@ -1620,27 +2000,30 @@ contract StakedTokenBptRev2 is
...
@@ -1666,12 +2049,17 @@ contract StakedTokenBptRev2 is
...
@@ -1726,9 +2114,13 @@ contract StakedTokenBptRev2 is
     uint256 userBalance,
     bool updateStorage
   ) internal returns (uint256) {
-    uint256 accruedRewards =
...
+    uint256 unclaimedRewards = stakerRewardsToClaim[user] + accruedRewards;
     ...
     if (accruedRewards != 0) {
       if (updateStorage) {
@@ -1759,30 +2151,31 @@ contract StakedTokenBptRev2 is
...
+          (amountToReceive + toBalance);
     ...
     return toCooldownTimestamp;
@@ -1793,23 +2186,29 @@ contract StakedTokenBptRev2 is
...
+    return REVISION();
   ...
   /**
@@ -1836,17 +2235,25 @@ contract StakedTokenBptRev2 is
     //solium-disable-next-line
...
@@ -1900,7 +2307,7 @@ contract StakedTokenBptRev2 is
...
@@ -1945,11 +2352,18 @@ contract StakedTokenBptRev2 is
     bytes32 r,
     bytes32 s
   ) public {
-    bytes32 structHash =
...
@@ -1974,8 +2388,12 @@ contract StakedTokenBptRev2 is
     bytes32 r,
     bytes32 s
   ) public {
...
+    );
     ...
     require(signatory != address(0), 'INVALID_SIGNATURE');
     require(nonce == _nonces[signatory]++, 'INVALID_NONCE');
@@ -1984,3 +2402,712 @@ contract StakedTokenBptRev2 is
